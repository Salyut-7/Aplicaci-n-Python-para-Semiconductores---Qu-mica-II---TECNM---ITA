...
ESTRUCTURA_CRISTALINA = {
    ...
    # Otros elementos tienen estructuras más complejas o no metálicas
    # Los dejamos sin clasificar por ahora
}
...
def dibujar_prisma_hexagonal(ax, altura=1.633, color='blue'):
    """Dibuja las aristas de un prisma hexagonal para HCP"""
    a = 1.0
    c = altura
...
class VisorCeldillaUnitaria(Gtk.Box):
    ...
    def actualizar_elemento(self, z):
        ...
        if z in ESTRUCTURA_CRISTALINA:
            ...
            indices = {"SC": 0, "BCC": 1, "FCC": 2, "HCP": 3}
